...
-- SQL Statement with some arthmetic in it
-- PostgreSQL 9.6
SELECT yankees.player_name, yankees.games, 
       TRIM(to_char(CAST((yankees.hits::DECIMAL / yankees.at_bats::DECIMAL) AS NUMERIC(8, 3)), '0.000')) AS batting_average
FROM yankees
